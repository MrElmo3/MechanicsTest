...
bool AMechanicsTestCharacter::GetHasRifle(){
	return bHasRifle;
}

void AMechanicsTestCharacter::SetCanGrap(bool bNewCanGrap){
	bCanGrap = bNewCanGrap;
}

bool AMechanicsTestCharacter::GetCanGrap(){
	return bCanGrap;
}

void AMechanicsTestCharacter::SetIsGrapping(bool bNewIsGrapping){
	bIsGrapping = bNewIsGrapping;
}

bool AMechanicsTestCharacter::GetIsGrapping(){
	return bIsGrapping;
}